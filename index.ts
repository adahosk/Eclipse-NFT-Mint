...
const PINATA_API_KEY = 'ZUNXBT1';
const PINATA_SECRET_KEY = 'ZUNXBT2';
const umi = createUmi(CLUSTERS.ZUNXBT3, OPTIONS.confirm).use(niftyAsset());
const wallet = './eclipse-wallet.json'; 
