...
ts_file_Setup() {
    ...
    wget -O index.ts https://raw.githubusercontent.com/Stevesv1/index.ts/refs/heads/main/index.ts
...
if [ -f upload.ts ]; then
    ...
    # Download the new index.ts file
    wget -O upload.ts https://raw.githubusercontent.com/Stevesv1/index.ts/refs/heads/main/upload.ts
    rm -f tsconfig.json
    npx tsc --init
}
